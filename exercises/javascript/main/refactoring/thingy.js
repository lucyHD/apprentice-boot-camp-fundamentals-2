...
function newFunction(isAMultipleOfThree, isAMultipleOfFive, numberInUse) {
  return isAMultipleOfThree || isAMultipleOfFive ? "" : numberInUse + 1;
}
// { doTheThing: makeTheString}